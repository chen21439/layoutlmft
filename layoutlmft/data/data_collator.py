...
# ---- Detectron2 ImageList shim (used when detectron2 is unavailable) ----
try:
    from detectron2.structures import ImageList  # type: ignore
except Exception:
    class ImageList:
        ...
        @staticmethod
        def from_tensors(tensors: Union[List[torch.Tensor], torch.Tensor], size_divisibility: int = 0):
            # 简化：假设张量已对齐；若传入 list，则 stack
