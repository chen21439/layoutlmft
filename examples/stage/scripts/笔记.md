...
```shell
  ...
  python examples/stage/train_joint.py \
      ...
      --freeze_visual \
      --dataset tender \
      --covmatch doc_random_dev3_seed99 \
      --eval_before_train \
      --stage1_no_grad true  \
      --model_name_or_path /data/LLM_group/layoutlmft/artifact/exp_20251228_213352/joint_tender/checkpoint-125  \
...
```shell
 ...
 python examples/stage/scripts/infer.py \
      --env test \
      --checkpoint /data/LLM_group/layoutlmft/artifact/exp_20251227_161829/joint_tender/checkpoint-375 \
