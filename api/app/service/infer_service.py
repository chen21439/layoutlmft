...
from comp_hrdoc.utils.line_merge import merge_connected_lines
...
class InferenceService:
        ...
        try:
            ...
            for row_idx, tr in enumerate(rows):
                ...
                for cell_elem in tr:
                    ...
                    # 获取单元格自己的 page 和 bbox
                    cell_bbox = cell_elem.get('bbox')
                    cell_page = cell_elem.get('page', '1')
                    cell_coords = self._parse_bbox(cell_bbox, cell_page) if cell_bbox else ""
    ...
    def _build_split_result(
        ...
        all_items = merge_connected_lines(all_items)
