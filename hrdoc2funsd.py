...
if __name__ == "__main__":
    # 示例数据路径
    HRDOC_EXAMPLES = "/mnt/e/programFile/AIProgram/modelTrain/HRDoc/examples/HRDS"
    OUTPUT_DIR = "/root/code/layoutlmft/data/hrdoc_funsd_format"
    ...
    # 转换示例数据（全部作为 train）
    print("\n[1/2] 转换示例数据...")
    convert_hrdoc_to_funsd(HRDOC_EXAMPLES, OUTPUT_DIR, split_name="train")
